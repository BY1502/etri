...
async def summary(request: Request, ns: str | None = None):
    ...
    gpu, system, ray, mlflow, mlflow_models, mlflow_experiment_runs, notebook_resources, running_notebooks, pvc, gpu_trend, ray_trend, ray_cluster_util, ray_node_count, kserve_rps, kserve_latency_p95, kserve_error_rate, kserve_top5_latency = await asyncio.gather(
        ...
        monitoring_service.get_ray_status(filter_ns),
        ...
        monitoring_service.get_ray_trend(namespace=filter_ns, window_minutes=60, step="1m"),
        monitoring_service.get_ray_cluster_util_trend(namespace=filter_ns, window_minutes=60, step="1m"),
        monitoring_service.get_ray_node_count_trend(namespace=filter_ns, window_minutes=60, step="1m"),
